...
| H2 | Ценовой компонент vs давление на бюджеты | Согласуется с гипотезой | −0,7 п.п. давления, 0 п.п. цена, +3,0 п.п. остальные |
...
│ └── smart_consumption.db/ 30 таблиц SQLite
├── r/
...
- **SQL** (SQLite) — аналитические запросы, 30 таблиц
