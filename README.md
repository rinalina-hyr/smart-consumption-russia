...
|---|---|---|---|
| H1 | Возраст влияет на умное потребление сильнее, чем пол | ✅ | range, ANOVA |
| H2 | Финансовая осторожность и умное потребление растут синхронно | ✅ | временные ряды |
| H3 | Умное потребление ≠ экономия | ✅ | дескриптивный анализ |
| H4 | Доля умных достигнет 44–46% к 2028 | ✅ | три сценария |
| H5 | Товарные категории делятся на 3 типа по динамике | ✅ | k-means, PCA |
